...
final class PicassoDrawable extends BitmapDrawable {
  ...
  static void setBitmap(ImageView target, Context context, Bitmap bitmap,
      Picasso.LoadedFrom loadedFrom, boolean noFade, boolean debugging,com.squareup.picasso.Callback callback,String uri) {
    Drawable placeholder = target.getDrawable();
    if (placeholder instanceof AnimationDrawable) {
      ((AnimationDrawable) placeholder).stop();
    }
    PicassoDrawable drawable =
        new PicassoDrawable(context, bitmap, placeholder, loadedFrom, noFade, debugging,callback,uri);
  ...
  boolean animating;
  int alpha = 0xFF;
  com.squareup.picasso.Callback mCallback;
  String mUri;
